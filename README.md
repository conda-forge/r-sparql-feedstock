...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5788&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-sparql-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-sparql` can be installed with `conda`:
...
```
mamba install r-sparql
```

It is possible to list all of the versions of `r-sparql` available on your platform with `conda`:
...
```
mamba search r-sparql --channel conda-forge
```
...
mamba repoquery search r-sparql --channel conda-forge

# List packages depending on `r-sparql`:
mamba repoquery whoneeds r-sparql --channel conda-forge

# List dependencies of `r-sparql`:
mamba repoquery depends r-sparql --channel conda-forge
```
